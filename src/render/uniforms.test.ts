...
describe('buildLayerUniforms', () => {
  ...
  it('zeroes the amplitude of a disabled layer so it keeps its slot but does not move', () => {
    const uniforms = buildLayerUniforms([layerWith({ amplitude: 5, scale: 40 }, false)])
